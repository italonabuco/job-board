...
export type PaginationListResolvers<ContextType = ResolverContext, ParentType extends ResolversParentTypes['PaginationList'] = ResolversParentTypes['PaginationList']> = {
